...
public class MainSetup implements Setup {
    ...
    public void init(NutConfig nutConfig) {
        ...
        Daos.createTablesInPackage(dao, "cc.southseast.bean", false);

        User user = null;
        try {
            user = new User("i@southseast.cc", "南溟", MD5Util.Generate("south"), 1, "12345678910", "XM", "CTFer", "XMUT", "我想带你去看晴空万里", "https://southseast.cc", "https://github.com.southseast", 1);
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        }
        if (dao.fetch(User.class, user.getEmail()) == null) {
            dao.insert(user);
        }
        ...
        if (0 == dao.count(Config.class)) {
            dao.insert(new Config(1, "南溟有猫", "Copyright ©2019 南溟丷"));
        }
