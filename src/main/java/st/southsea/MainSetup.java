...
public class MainSetup implements Setup {
    ...
    public void init(NutConfig nutConfig) {
        ...
        Daos.createTablesInPackage(dao, "st.southsea.bean", false);

        User user = null;
        try {
            user = new User("i@southsea.st", "南溟", MD5Util.Generate("south"), 1, "12345678910", "XM", "CTFer", "XMUT", "我想带你去看晴空万里", "https://southsea.st", "https://github.com.southseast", 1);
